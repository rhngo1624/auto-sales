...
public class EditCarController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle rb){
        ...
        fillTotalSeatsBox();
        fillDoorAmountBox();
        System.out.println("ID: " + AdministrationController.getSelected());
        Car c = new Cars().get(AdministrationController.getSelected());

        makeField.setText(c.getMake());
        modelField.setText(c.getModel());
        yearBox.setValue(c.getYear());
        fuelEconomyBox.setValue(c.getFuelEconomy());
        transmissionBox.setValue(c.getTransmission());
        totalSeatsBox.setValue(c.getTotalSeating());
        doorAmountBox.setValue(c.getDoorAmount());
        engineTypeBox.setValue(c.getEngineType());
        priceField.setText(String.valueOf(c.getPrice()));
        imgPath = c.getImageLocation();
    ...
    public void update(){
        ...
        if(validate()){
            ...
            c.setID(AdministrationController.getSelected());
